...
Para rodar o projeto é necessário ter instalado o PHP versão 8.2.4, Xampp e a depêndencia Composer. Depois de ter realizado a instalação das depêndencia, é necessário criar uma database MySQL e atualizar o arquivo .env na pagina do projeto com as informações: nome da database, username e password.
